...
import { getHRResult } from './api/hr'

function HRResult({ sessionId, onRestart }) {
  const [state, setState] = useState({ status: 'loading' })

  useEffect(() => {
    let cancelled = false
    getHRResult(sessionId)
      .then((data) => {
  ...
  return (
    <div className="card">
      ...
      <p className="coding-next-note">Final evaluation is coming soon.</p>
